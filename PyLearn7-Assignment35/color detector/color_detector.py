...
while True:
    ...
    if blue > 0.33 * (box.shape[0] * box.shape[1]) and green > 0.33 * (box.shape[0] * box.shape[1]) and red > 0.33 * (box.shape[0] * box.shape[1]):
        color = "[white]" 
    elif red > 0.45 * (box.shape[0] * box.shape[1]) and green > 0.45 * (box.shape[0] * box.shape[1]):
        color = "[yellow]"
